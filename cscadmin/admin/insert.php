...
<form name="form2" method="post" style="margin:auto;">
...
$query="insert into product (product_code, product_name, pro_cat, product_price, description, brnad, category, features, plateform, model, type, display, waranty, shipping_time, price, offer_price, save, image1)                      values($pcode','$pname','$pcat','$price','$desc','$brand','$category','$features','$plateform','$model','$type','$display','$waranty','$shipping_time','$price','$offer_price','$save','$image')";
