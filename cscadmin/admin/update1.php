...
<form name="form2" action="update2.php" method="post" style="margin:auto;" >
...
//			 echo"<br>$query";
		...
		?>
           ...
           <td  align="center"><a href='update2.php?x=<?php echo"$row[product_code]";?>' style="text-decoration:none;">
           <input type="button" name="view" value="VIEW" style="width:100px; height:25px; color:#FFFFFF; border:#FFFFFF 1px solid; background-color:#006699; border-radius:5px;"></a>
