...
<a href="update1.php" style="text-decoration:none; color:#FFFFFF;"><input type="button"  value="BACK" style="width:100px; height:25px; color:#FFFFFF; border:#FFFFFF 1px solid; background-color:#000033; border-radius:5px;"></a>
</div>
