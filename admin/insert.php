...
<form name="form2" method="post" enctype="multipart/form-data" style="margin:auto;" >
             ...
             <tr><td>Category:</td><td width="349"><input type="text" name="category" />
               ...
               <td>Image:</td><td width="349"><input type="file" name="image"/></td></tr>
...
// $plateform = isset($_POST['plateform']) ? $_POST['plateform'] : '';
// $model = isset($_POST['model']) ? $_POST['model'] : '';
// $type = isset($_POST ['type']) ? $_POST['type'] : '';
// $display = isset($_POST['display']) ? $_POST['display'] : '';
// $waranty = isset($_POST['waranty']) ? $_POST['waranty'] : '';
// $shipping_time = isset($_POST['shipping_time']) ? $_POST['shipping_time'] : '';
...
// $query="insert into product (product_code, product_name, pro_cat, product_price,description, brand, category, features, plateform, model, type, display,warenty,shipping_time, price, offer_price, save)
// values ($pcode','$pname','$pcat','$price','$desc','$brand','$category','$features','$plateform','$model','$type','$display','$waranty','$shipping_time','$price','$offer_price','$save')";
//
...
$query="insert into product (product_code, product_name, pro_cat, product_price, description, brand, category, features, plateform, model, type, display, waranty, shipping_time, price, offer_price, save, image1 )
values('$pcode','$pname','$pcat','$price','$desc','$brand','$category','$features','$plateform','$model','$type','$display','$waranty','$shipping_time','$price','$offer_price','$save', '$image')";
