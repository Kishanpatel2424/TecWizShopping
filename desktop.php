...
<title>Tec Wiz Shopping/laptops</title>
...
<!--slider down data-->
            ...
            <table style="height:auto; width:1050px; margin:auto; margin-bottom:10px;border:0px solid #000000; background-color:#668B8B; ">
			 ...
			 $query="select * from product where pro_cat='desktop'";
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:300px; width:230px; float:left;border:1px solid black;border-radius:10px; border-style: solid;border-width: medium; margin-left:12px; margin-top:20px;">
