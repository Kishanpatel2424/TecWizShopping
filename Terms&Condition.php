...
<title>Tec Wiz Shopping/Privacy-Policy</title>
...
<!--slider down data-->
            ...
            <table style="height:auto; width:1050px; border-bottom:10px;  margin-top:20px; margin:auto; background-color:#668B8B; border:0px solid #000000; " align="center">
...
$server=$conn->query("select * from static where page='Terms&Condition'");
