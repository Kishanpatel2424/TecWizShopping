...
<title>Tec Wiz Shopping/Myaccount</title>
...
<!--slider down data-->
         ...
         <font style=" font-size:18px; margin-left:10px;"><b>My Account</b></font>
           ...
           <div style="width:200px; height:248px;background-color:darkgray;border:0px #CCCCCC solid;float:left;"><?php include('left.php'); ?></div>
