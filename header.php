...
<!--logo--><div style="width:150px; height:115px; float:left; border:0px solid #FFF;"><a href="index.php"><img src="images/LOGO.PNG"  height="118" width="150"/></a></div><!--logo close-->
...
<div style="height:20px; width:490px; border:0px solid #FF0000; float:left;" align="center">
  <strong style="color:firebrick; font-size:32px; font-family:"Courier New", Courier, monospace; margin-top:0px;" align="top"><b><h2>Tec Wiz Shopping</h2></b></strong>
...
$email=$_SESSION['email'];
    $query="select * from user_details where email='$email'";
	      ...
	      {
		  ?>
		  <p style=" color:#FFFFFF; font-family:'Monotype Corsiva'; font-size:22px;"><b>Welcome: <font style=" font-size:20px;"> &nbsp; <?php echo $row['first_name'], $row['last_name'];?></font></b></p>
