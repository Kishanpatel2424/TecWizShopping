...
<form  method="post" action="secure.php" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">
  ...
  <tr>
    ...
    <td  align="left" width="100%"><input name="account_id" type="text">
    ...
    <td align="left"><input name="return_url" type="text" size="60" value="http://yourdomain.com/response.php?DR={DR}" /></td>
  </tr>
  <tr>
